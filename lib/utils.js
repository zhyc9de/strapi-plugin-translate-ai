...
**IMPORTANT: Only output the pure JSON object. Do NOT include any explanations, comments, code block markers, or any other text. The response must be valid JSON.**

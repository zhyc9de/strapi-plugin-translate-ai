...
Output Format:
For the final response, provide ONLY the resulting JSON object where the original string values have been replaced by their final idiomatic translations (${targetLang}) from step 3. Do not include the intermediate steps (Direct Translation, Identify Issues) or any extra text in the final output. The output must be a valid JSON object.`
